...
const Footer = ({ footer, links }) => {
  return (
    <footer className="bg-brand1  w-full" id='footer'>
      <Container className="footer pt-8 px-5 pb-6 md:pt-16 md:px-16  lg:pt-14  lg:px-[152px] md:text-base md:font-semibold">
        <div className="flex flex-col items-center md:flex-row md:justify-between md:items-start ">
          <div className="flex mb-16 md:mb-0 gap-x-6 md:gap-x-4 lg:gap-x-4 items-start  ">
            <div className="relative h-12 w-12 md:h-16 md:w-16 md:mr-7 lg:mr-10">
              <LogoIcon />
            </div>

            <address>
              <p className="mb-4 not-italic">{footer.connection}</p>
              <p className="mb-4 not-italic">{footer.address}</p>
              <p className="mb-4 not-italic">{footer.email}</p>
